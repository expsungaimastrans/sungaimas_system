...
class ShipmentController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('shipments.index', [
            ...
            'filters'       => [
                ...
                'from'              => $from, // kalau admin, tetap null
                'to'                => $to,
            ],
        ]);
    }
    ...
    public function success($id)
    {
        ...
        // flag valid/tidaknya nomor WA (dipakai di blade untuk enable/disable tombol)
        ...
        return view('shipments.success', compact('shipment', 'canWaPenerima', 'canWaPengirim'));
    }
