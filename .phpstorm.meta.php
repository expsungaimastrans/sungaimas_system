...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/antoniustri/expedisi-sungaimas/public/storage' => 'string',
            ...
            'services.kirimi.user_code' => 'string',
            'services.kirimi.secret' => 'string',
            'services.kirimi.device_id' => 'string',
...
'filesystems.disks.s3.bucket','filesystems.disks.s3.endpoint','filesystems.disks.s3.url','filesystems.disks.s3.use_path_style_endpoint','filesystems.links./Users/antoniustri/expedisi-sungaimas/public/storage',
...
'services.slack.notifications.channel','services.kirimi.user_code','services.kirimi.secret','services.kirimi.device_id','session.driver',
...
'files.view','dashboard','dashboard.data','shipments.index','shipments.pdf',
'shipments.success','shipments.search','shipments.showJson','shipments.create','shipments.store',
'shipments.edit','shipments.update','shipments.setPembayaran','shipments.export.csv','shipments.export.muat',
'shipments.sendWa','manifests.create','manifests.store','manifests.edit','manifests.update',
'manifests.addShipment','manifests.removeShipment','manifests.index','manifests.show','manifests.pdf',
'manifests.updateStatus','finance.index','finance.manifest','finance.manifest.biaya','finance.shipment.update',
'finance.manifest.shipments','finance.invoices','finance.invoices.data','finance.invoices.store','finance.invoices.list',
'finance.invoices.availableShipments','finance.invoices.pdf','finance.invoices.status','finance.invoices.sendWa','finance.invoices.edit',
'finance.invoices.addShipment','finance.invoices.removeShipment','finance.invoices.show','customers.index','customers.create',
'customers.store','customers.show','customers.edit','customers.update','customers.destroy',
'customers.import.form','customers.import','customers.export.csv','customers.api.search','storage.local',);
...
'components.primary-button','components.responsive-nav-link','components.secondary-button','components.text-input','customers._autocomplete',
'customers.create','customers.edit','customers.import','customers.index','customers.show',
'dashboard','dashboard.index','finance.index','finance.invoice_edit','finance.invoice_show',
'finance.invoices','finance.invoices_list','finance.manifest','finance.tagihan-create','finance.tagihan-pdf',
'layouts.app','layouts.guest','layouts.navigation','manifests.create','manifests.edit',
'manifests.index','manifests.pdf','manifests.show','partials.navbar','profile.edit',
'profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','shipments.create','shipments.edit',
'shipments.index','shipments.pdf','shipments.success','welcome','laravel-exceptions::401',
...
'LOG_LEVEL','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER',
...
'DB_PASSWORD','SESSION_LIFETIME','SESSION_ENCRYPT','SESSION_PATH','SESSION_DOMAIN',
'SESSION_DRIVER','SESSION_SECURE_COOKIE','SESSION_SAME_SITE','BROADCAST_CONNECTION','FILESYSTEM_DISK',
...
'AWS_URL','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','KIRIMI_USER_CODE','KIRIMI_SECRET',
'KIRIMI_DEVICE_ID',);
